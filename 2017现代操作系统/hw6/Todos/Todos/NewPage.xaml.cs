...
namespace Todos
{
    ...
    public sealed partial class NewPage : Page
    {
        ...
        private Uri imageUri = new Uri(Models.TodoItem.defalutImagePath);   // 保存图片路径/默认背景图片
        ...
        private async void CreateButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ViewModel.AddTodoItem(newTitle, newDescription, imageUri, bitmapImage, dueDate);
                }
                else
                {
                    ViewModel.UpdateTodoItem(ViewModel.SelectedItem.getId(), newTitle, newDescription, imageUri, bitmapImage, dueDate);
                }
                Frame.Navigate(typeof(MainPage), ViewModel);
            }
