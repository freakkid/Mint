    ...
    public sealed partial class MainPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else
            {
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey("TheWorkInProgress"))
                {
                    ...
                    MainPageUserDataToSave userData = MainPageUserDataToSave.DeserializeUserData(composite["userData"]);
                    upCheckBox.IsChecked = userData.upCheckBox;
                    upLine.Visibility = userData.upLine;
                    downCheckBox.IsChecked = userData.downCheckBox;
                    downLine.Visibility = userData.downLine;
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            ...
            if (suspending)
            {
                ...
                MainPageUserDataToSave userData = new MainPageUserDataToSave(upCheckBox.IsChecked, upLine.Visibility,
                                                                             downCheckBox.IsChecked, downLine.Visibility);
